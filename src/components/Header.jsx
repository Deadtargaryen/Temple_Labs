...
const Header = () => {
  ...
  return (
    <div
      ...
      border-b border-n-6 lg:border-n-8/90
    lg:backdrop-blur-sm ${
    ...
    >
      ...
      xl:px-10 max-lg:px-4"
      >
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={brainwave} width={190} height={40} alt="temple" />
        </a>
          ...
          >
            {navigation.map((item) => (
              <a
                ...
                text-n-1 trasition-colors hover:text-color-1 
                ${
                  item.onlyMobile ? "lg:hidden" : ""
                } px-6 py-6 md:8 lg:-mr-0.25 lg:text-xs lg:font-semibold ${
