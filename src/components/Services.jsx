      ...
      <div className="container">
        ...
        <div className="relative">
          ...
          >
            ...
            <Generating
              className="absolute left-4 right-4 bottom-14 
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            >
              ...
              >
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your photo using our AI app&apos;s photo
                  enhancing feature. Hop on it now!
                </p>
              </div>
            ...
            >
              <div className="py-12 px-4 xl:px-8">
                ...
                <p className="font-code body-2 mb-[2rem] text-n-3">
